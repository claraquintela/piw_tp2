...
<body>
  ...
  <main>
    ...
    <section>
      ...
      <form method="post" data-js-formulaire>
        <div>
    ...
    <section class="to-do-list">
      ...
      <div class="to-do-list__actions" data-js-trier-taches>
        ...
        require_once('requetes/functionsDB.php');
        $taches = getAllTasks();
        // Récupération des résultats sous forme de tableau associatif
        while ($tache = mysqli_fetch_assoc($taches)) {
          echo '<div data-js-tache=' . $tache['id'] . '>
          <p>
              <span data-js-tache-tache data-tache="' . $tache['tache'] . '">
                  <small>Tâche : </small>' . $tache['tache'] . '
              </span>
              -
              <span data-js-tache-importance data-importance="' . $tache['importance'] . '">
                  <small>Importance : </small> ' . $tache['importance'] . '
              </span>

              <span class="hidden"  data-js-tache-description data-description="' . $tache['description'] . '" ></span>
